...
function Login() {
  ...
  const makeAPIRequest = (email) => {
    const apiUrl =
      "https://aqs85q6n1m.execute-api.us-east-1.amazonaws.com/prod/get-role-restaurant";
    ...
    <div>
      <div style={backgroundStyle}>
        ...
        <Container component="main" maxWidth="xs" style={containerStyle}>
          ...
          <ToastContainer />
          <button onClick={() => navigate("/Signup")}>Switch to Signup</button>
        </Container>
      </div>
    </div>
  );
